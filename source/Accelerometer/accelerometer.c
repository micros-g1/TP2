...
void accel_init(){
	...
	systick_add_callback(handling_reading, SYSTICK_HZ_TO_RELOAD(800), PERIODIC);			//800 Hz or more!!!
	systick_add_callback(handling_reading_calls, SYSTICK_HZ_TO_RELOAD(200), PERIODIC);		//less than 800 Hz!!!
